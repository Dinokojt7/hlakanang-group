    ...
    <div className="section-pad mx-auto max-w-7xl">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
        ...
        >
          ...
          {/* ✅ FIXED Mobile stats pill */}
          <div className="absolute -bottom-5 left-5 right-5 sm:left-6 sm:right-auto bg-charcoal rounded-xl px-4 py-4 flex justify-between sm:hidden overflow-hidden">
            {stats.map((s) => (
              <div
                key={s.label}
              ...
              >
                ...
                <span className="text-white/55 text-[11px] leading-tight text-center break-words">
                  {s.label}
                </span>
              </div>
            ))}
